...
--
-- Name: element_types; Type: TABLE; Schema: public; Owner: freecodecamp
--

CREATE TABLE public.element_types (
    element_type_id integer NOT NULL,
    element_type_name character varying NOT NULL
);


ALTER TABLE public.element_types OWNER TO freecodecamp;

--
-- Name: element_types_element_type_id_seq; Type: SEQUENCE; Schema: public; Owner: freecodecamp
--

CREATE SEQUENCE public.element_types_element_type_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
ALTER TABLE public.element_types_element_type_id_seq OWNER TO freecodecamp;

--
-- Name: element_types_element_type_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: freecodecamp
--

ALTER SEQUENCE public.element_types_element_type_id_seq OWNED BY public.element_types.element_type_id;
...
--
-- Name: element_types element_type_id; Type: DEFAULT; Schema: public; Owner: freecodecamp
--

ALTER TABLE ONLY public.element_types ALTER COLUMN element_type_id SET DEFAULT nextval('public.element_types_element_type_id_seq'::regclass);


--
-- Data for Name: element_types; Type: TABLE DATA; Schema: public; Owner: freecodecamp
--

INSERT INTO public.element_types VALUES (1, 'nonmetal');
INSERT INTO public.element_types VALUES (2, 'metal');
INSERT INTO public.element_types VALUES (3, 'metalloid');
...
--
-- Name: element_types_element_type_id_seq; Type: SEQUENCE SET; Schema: public; Owner: freecodecamp
--

SELECT pg_catalog.setval('public.element_types_element_type_id_seq', 3, true);


--
-- Name: element_types element_types_pkey; Type: CONSTRAINT; Schema: public; Owner: freecodecamp
--

ALTER TABLE ONLY public.element_types
    ADD CONSTRAINT element_types_pkey PRIMARY KEY (element_type_id);
